                    ...
                    <div class="col">
                      <div class="doctor-table-blk">
                        ...
                        <div class="doctor-search-blk">
                          ...
                          <div class="add-group">
                            <a href="add-department.php" class="btn btn-primary add-pluss ms-2"><img
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="profile-image">
                          <a href="profile.php"><img width="28" height="28" src="../assets/img/profiles/avatar-01.jpg"
                      ...
                      <tr>
                        ...
                        <td>Urologia</td>
                        <td class="profile-image">
                          <a href="profile.php"><img width="28" height="28" src="../assets/img/profiles/avatar-02.jpg"
                              class="rounded-circle m-r-5" alt />
                            Dr.Smith Bruklin</a>
                        </td>
                        <td>Investiga e trata problemas...</td>
                      ...
                      <tr>
                        ...
                        <td>Radiologia</td>
                        <td class="profile-image">
                          <a href="profile.php"><img width="28" height="28" src="../assets/img/profiles/avatar-03.jpg"
                              class="rounded-circle m-r-5" alt />
                      ...
                      <tr>
                        ...
                        <td>Odontologia</td>
                        <td class="profile-image">
                          <a href="profile.php"><img width="28" height="28" src="../assets/img/profiles/avatar-04.jpg"
                              class="rounded-circle m-r-5" alt />
                            Dr.Bernardo James</a>
                        </td>
                        <td>Investiga e trata problemas...</td>
                      ...
                      <tr>
                        ...
                        <td>Ginecologia</td>
                        <td class="profile-image">
                          <a href="profile.php"><img width="28" height="28" src="../assets/img/profiles/avatar-06.jpg"
                      ...
                      <tr>
                        ...
                        <td>Ginecologia</td>
                        <td class="profile-image">
                          <a href="profile.php"><img width="28" height="28" src="../assets/img/profiles/avatar-05.jpg"
                              class="rounded-circle m-r-5" alt />
                            Lorem Ipsum</a>
                        </td>
                        <td>Investiga e trata problemas...</td>
...
<!-- Mirrored from preclinic.dreamstechnologies.com/html/template/departments.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Jun 2024 21:43:17 GMT -->
