...
<body>
          ...
          <ul>
            ...
            <li class="submenu">
              ...
              <ul style="display: none">
                ...
                <li><a href="../admin/doctor-dashboard.html">Painel do Médico</a></li>
                <li>
                  <a href="patient-dashboard.html">Painel do Paciente</a>
                </li>
              </ul>
            </li>
            <li class="submenu">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="profile-image">
                          <a href="profile.html"><img width="28" height="28" src="../assets/img/profiles/avatar-01.jpg"
                              class="rounded-circle m-r-5" alt />
                            Dr.Lorem Ipsum </a>
                        </td>
                        <td>Investiga e trata problemas...</td>
                        <td>01.10.2022</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>Urologia</td>
                        <td class="profile-image">
                          <a href="profile.html"><img width="28" height="28" src="../assets/img/profiles/avatar-02.jpg"
                              class="rounded-circle m-r-5" alt />
                            Dr.Smith Bruklin</a>
                        </td>
                        <td>Investiga e trata problemas...</td>
                      ...
                      <tr>
                        ...
                        <td>Radiologia</td>
                        <td class="profile-image">
                          <a href="profile.html"><img width="28" height="28" src="../assets/img/profiles/avatar-03.jpg"
                              class="rounded-circle m-r-5" alt />
                            Dr.William Stephin</a>
                        </td>
                        <td>Investiga e trata problemas...</td>
                        <td>01.10.2022</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>Odontologia</td>
                        <td class="profile-image">
                          <a href="profile.html"><img width="28" height="28" src="../assets/img/profiles/avatar-04.jpg"
                              class="rounded-circle m-r-5" alt />
                            Dr.Bernardo James</a>
                        </td>
                        <td>Investiga e trata problemas...</td>
                      ...
                      <tr>
                        ...
                        <td>Ginecologia</td>
                        <td class="profile-image">
                          <a href="profile.html"><img width="28" height="28" src="../assets/img/profiles/avatar-06.jpg"
                              class="rounded-circle m-r-5" alt />Dr.Lorem Ipsum </a>
                        </td>
                        <td>Investiga e trata problemas...</td>
                        <td>05.10.2022</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>Ginecologia</td>
                        <td class="profile-image">
                          <a href="profile.html"><img width="28" height="28" src="../assets/img/profiles/avatar-05.jpg"
                              class="rounded-circle m-r-5" alt />
                            Lorem Ipsum</a>
                        </td>
                        <td>Investiga e trata problemas...</td>
  ...
  <script src="../assets/js/feather.min.js" type="155de63393eca00730a5647f-text/javascript"></script>
  <script src="../assets/js/jquery.slimscroll.js" type="155de63393eca00730a5647f-text/javascript"></script>
  <script src="../assets/plugins/datatables/jquery.dataTables.min.js"
    type="155de63393eca00730a5647f-text/javascript"></script>
  <script src="../assets/plugins/datatables/datatables.min.js" type="155de63393eca00730a5647f-text/javascript"></script>
  <script src="../assets/js/app.js" type="155de63393eca00730a5647f-text/javascript"></script>
  <script src="../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
    data-cf-settings="155de63393eca00730a5647f-|49" defer></script>
</body>

<!-- Mirrored from preclinic.dreamstechnologies.com/html/template/departments.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Jun 2024 21:43:17 GMT -->
