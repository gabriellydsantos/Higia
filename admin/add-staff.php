    ...
    <div class="page-wrapper">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                $firstName = $_POST['first_name']; // Certifique-se de que este campo está sempre preenchido
                                ...
                                $username = strtolower($firstName) . "_" . $carteirinha; // Corrigido
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                                ...
                                if ($stmt = $conn->prepare($sql)) {
                                    ...
                                    if ($stmt->execute()) {
                                        echo '<div class="message success">Novo funcionários cadastrado com sucesso!</div>';
                                    } else {
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-heading">
                                            <h4>Detalhes do funcionários</h4>
                                        </div>
                                    </div>
