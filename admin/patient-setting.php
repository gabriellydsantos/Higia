                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="tab-content-set">
                        <ul class="nav">
                          <li>
                            <a href="patient-profile.html"><span class="set-about-icon me-2"><img
                        ...
                        <form>
                          <div class="row">
                            ...
                            <div class="col-12 col-sm-12">
                              <div class="input-block local-forms">
                                <label>Móvel </label>
                                <input class="form-control" type="text" value="+55 11 987654321" />
                              </div>
                            </div>
                            <div class="col-12 col-sm-12">
                              <div class="input-block local-forms">
                                <label>E-mail </label>
                                <input class="form-control" type="email" value="loremIpsum@gmail.com" />
                              </div>
                            </div>
                          </div>
                          <div class="col-12">
