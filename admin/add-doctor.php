                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 col-xl-4">
                                            <div class="input-block local-forms">
                                                ...
                                                <input class="form-control" type="text" name="doctor_first_name"
                                        ...
                                        <div class="col-12 col-md-6 col-xl-4">
                                            <div class="input-block local-forms">
                                                ...
                                                <input class="form-control" type="text" name="doctor_last_name"
                                        ...
                                        <div class="col-12 col-md-6 col-xl-4">
                                            <div class="input-block local-forms">
                                                ...
                                                <input class="form-control" type="text" name="doctor_username"
                                        ...
                                        <div class="col-12 col-md-6 col-xl-6">
                                            <div class="input-block local-forms">
                                                ...
                                                <input class="form-control" type="email" name="doctor_email"
                                        ...
                                        <div class="col-12 col-md-6 col-xl-3">
                                            <div class="input-block local-forms cal-icon">
                                                ...
                                                <input class="form-control datetimepicker" type="text"
                                                    name="doctor_birth_date" placeholder="dd/mm/aaaa" required />
                                            </div>
                                        </div>
                                            ...
                                            <div class="input-block select-gender">
                                                ...
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" name="doctor_gender"
                                                            class="form-check-input mt-0" />Masculino
                                                    </label>
                                                </div>
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" name="doctor_gender"
                                                            class="form-check-input mt-0" />Feminino
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6 col-xl-6">
                                            <div class="input-block local-forms">
                                                ...
                                                <select class="form-control select" name="doctor_departament">
