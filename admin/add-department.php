...
<body>
          ...
          <ul>
            ...
            <li class="submenu">
              <a href="#"><span class="menu-side"><img src="../assets/img/icons/menu-icon-06.svg" alt /></span>
                <span> Departamento</span> <span class="menu-arrow"></span></a>
              <ul style="display: none">
                <li>
            ...
            <div class="col-sm-12">
              <ul class="breadcrumb">
                <li class="breadcrumb-item">
                  <a href="departments.html">Departamento </a>
                </li>
                <li class="breadcrumb-item">
                      ...
                      <div class="input-block select-gender">
                        ...
                        <div class="form-check-inline">
                          <label class="form-check-label">
                            <input type="radio" name="gender" class="form-check-input" />Ativa
                          </label>
                        </div>
                        <div class="form-check-inline">
                          <label class="form-check-label">
  ...
  <script src="../assets/js/bootstrap-datetimepicker.min.js" type="99b33d9fe545964c14218df7-text/javascript"></script>
...
<!-- Mirrored from preclinic.dreamstechnologies.com/html/template/add-department.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Jun 2024 21:43:17 GMT -->
