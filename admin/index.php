...
<body>
                ...
                <div class="chart-title patient-visit">
                  ...
                  <div>
                    <ul class="nav chat-user-total">
                      <li>
                        <i class="fa fa-circle current-users" aria-hidden="true"></i>Masculino 75%
                      </li>
                      <li>
          ...
          <div class="col-12 col-md-12 col-xl-8">
            <div class="card">
              <div class="card-header">
                ...
                <a href="appointments.html" class="patient-views float-end">Mostre tudo</a>
              </div>
                    ...
                    <thead>
                      <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1"
                          aria-label="Carterinha: activate to sort column ascending" style="width: 78.975px">
                          Carterinha
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1"
                          aria-label="Nome do paciente: activate to sort column ascending" style="width: 131.6px">
                          Nome do paciente
                        </th>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1"
                          aria-label="Data de nascimento : activate to sort column ascending" style="width: 145.788px">
                          Médico
                        </th>
                        <!-- <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                                    rowspan="1" colspan="1"
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="table-image appoint-doctor">
                          <img width="28" height="28" class="rounded-circle" src="../assets/img/profiles/avatar-02.jpg"
                            alt />
                      ...
                      <tr>
                        ...
                        <td>Lorem Ipsum</td>
                        <td class="table-image appoint-doctor">
                          <img width="28" height="28" class="rounded-circle" src="../assets/img/profiles/avatar-03.jpg"
                            alt />
                          <h2>Dr.Lorem Ipsum</h2>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>Lorem ipsum</td>
                        <td class="table-image appoint-doctor">
                          <img width="28" height="28" class="rounded-circle" src="../assets/img/profiles/avatar-04.jpg"
                            alt />
                          <h2>Dr.Lorem Ipsum</h2>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>Lorem ipsum</td>
                        <td class="table-image appoint-doctor">
                          <img width="28" height="28" class="rounded-circle" src="../assets/img/profiles/avatar-05.jpg"
                            alt />
                          <h2>Dr.Lorem ipsum</h2>
                        </td>
          ...
          <div class="col-12 col-xl-12">
            <div class="card">
              <div class="card-header pb-0">
                ...
                <a href="patients.html" class="float-end patient-views">Mostre tudo</a>
              </div>
      ...
      <div class="notification-box">
        <div class="msg-sidebar notifications msg-noti">
          ...
          <div class="topnav-dropdown-footer">
            <a href="chat.html">Veja todas as mensagens</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <script src="../assets/plugins/datatables/jquery.dataTables.min.js"
    type="df5f729902501f2e3972e202-text/javascript"></script>
  <script src="../assets/plugins/datatables/datatables.min.js" type="df5f729902501f2e3972e202-text/javascript"></script>
  ...
  <script src="../assets/plugins/apexchart/apexcharts.min.js" type="df5f729902501f2e3972e202-text/javascript"></script>
