            ...
            <div class="col-sm-12">
              <ul class="breadcrumb">
                <li class="breadcrumb-item">
                 <a href="/medic/schedule.html">Cronograma médico </a>
                </li>
                <li class="breadcrumb-item">
                      ...
                      <div class="input-block select-gender">
                        ...
                        <div class="form-check-inline">
                          <label class="form-check-label">
                            <input type="radio" name="gender" class="form-check-input" checked />Ativa
                          </label>
                        </div>
                        <div class="form-check-inline">
                          <label class="form-check-label">
                            <input type="radio" name="gender" class="form-check-input" />Em ativo
                          </label>
                        </div>
                      </div>
                    </div>
...
<!-- Mirrored from preclinic.dreamstechnologies.com/html/template/edit-schedule.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Jun 2024 21:43:17 GMT -->
