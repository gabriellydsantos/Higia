...
<body>
      ...
      <div class="content">
        ...
        <div class="row">
            ...
            <div class="card chat-box">
              <div class="chat-widgets">
                     ...
                     <a href="/medic/#" data-bs-toggle="dropdown" aria-expanded="false" class>
                      ...
                      <div class="dropdown-menu" style>
                        ...
                        <a class="dropdown-item" href="javascript:;"><i
                          ...
                          Archive</a>
                        <a class="dropdown-item" href="javascript:;"><i class="feather-trash-2 me-2 text-danger"></i>
                          Delete</a>
                        <a class="dropdown-item" href="javascript:;"><i class="feather-slash me-2 text-secondary"></i>
                          Block</a>
                      </div>
                    </div>
                  </div>
                ...
                <div class="compose-mail">
                 <a href="/medic/compose.html" class="btn btn-primary"><img src="../assets/img/icons/edit-2.svg" class="me-2"
                      alt="img" />Compose Mail</a>
                </div>
                <div class="email-menu-blk">
                  <ul>
                    <li class="active">
                     <a href="/medic/javascript:;"><img src="../assets/img/icons/inbox.svg" class="me-2"
                          alt="img" />Enviados<span class="comman-flex">50</span></a>
                    </li>
                    <li>
                     <a href="/medic/javascript:;"><img src="../assets/img/icons/trash.svg" class="me-2" alt="img" />Excluidos
                ...
                <div class="label-blk comman-space-flex">
                  ...
                  <ul class="nav label-add-list">
                    <li>
                     <a href="/medic/javascript:;" class="add-list-btn me-2"><i class="feather-plus"></i></a>
                    </li>
                    <li>
                     <a href="/medic/javascript:;" data-bs-toggle="dropdown" aria-expanded="false" class="add-list-btn">
                        <i class="feather-more-vertical"></i>
                      </a>
                      <div class="dropdown-menu" style>
                ...
                <div class="email-menu-blk">
                  <ul class="mb-0">
                    ...
                    <li>
                     <a href="/medic/javascript:;"><img src="../assets/img/icons/folder-icon-04.svg" class="me-2"
          ...
          <div class="col-xl-8">
            ...
            <input type="file" accept="image/*" name="image" id="file" onchange="if (!window.__cfRLUnblockHandlers) return false; loadFile(event)" class="hide-input" data-cf-modified-967dc55985ab8a5097efb074->
            ...
            <div class="col-lg-12">
            <div class="mail-send">
            <a href="javascript.html"><img src="assets/img/icons/trash.svg" class="me-2" alt="img"></a>
            <a href="javascript.html"><img src="assets/img/icons/ram.svg" class="me-2" alt="img"></a>
  ...
  <script src="../assets/plugins/datatables/jquery.dataTables.min.js"
    type="967dc55985ab8a5097efb074-text/javascript"></script>
  <script src="../assets/plugins/datatables/datatables.min.js" type="967dc55985ab8a5097efb074-text/javascript"></script>
  ...
  <script src="../assets/plugins/summernote/summernote-bs5.min.js"
    type="967dc55985ab8a5097efb074-text/javascript"></script>

  <script src="../assets/plugins/apexchart/apexcharts.min.js" type="967dc55985ab8a5097efb074-text/javascript"></script>
...
<!-- Mirrored from preclinic.dreamstechnologies.com/html/template/compose.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Jun 2024 21:43:51 GMT -->
