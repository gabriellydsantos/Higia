...
<body>
  ...
  <div class="main-wrapper">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <div class="m-t-20"><a href="/medic/#" class="btn btn-white" data-bs-dismiss="modal">Close</a>
    ...
    <script src="assets/js/jquery-3.7.1.min.js" type="a2f653978252afdfe70ff8a8-text/javascript"></script>
    <script src="assets/js/bootstrap.bundle.min.js" type="a2f653978252afdfe70ff8a8-text/javascript"></script>
    <script src="assets/js/feather.min.js" type="a2f653978252afdfe70ff8a8-text/javascript"></script>
    <script src="assets/js/jquery.slimscroll.js" type="a2f653978252afdfe70ff8a8-text/javascript"></script>
    <script src="assets/js/select2.min.js" type="a2f653978252afdfe70ff8a8-text/javascript"></script>

    <script src="assets/plugins/moment/moment.min.js" type="a2f653978252afdfe70ff8a8-text/javascript"></script>
    <script src="assets/js/bootstrap-datetimepicker.min.js" type="a2f653978252afdfe70ff8a8-text/javascript"></script>
    <script src="assets/js/app.js" type="a2f653978252afdfe70ff8a8-text/javascript"></script>
    <script src="../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="a2f653978252afdfe70ff8a8-|49" defer></script>
</body>

<!-- Mirrored from preclinic.dreamstechnologies.com/html/template/add-schedule.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Jun 2024 21:43:17 GMT -->
