...
<body>
      ...
      <div class="content">
            ...
            <div class="col-sm-12">
              <ul class="breadcrumb">
                <li class="breadcrumb-item">
                  <a href="/medic/index.html">Dashboard </a>
                </li>
                <li class="breadcrumb-item">
        ...
        <div class="good-morning-blk">
          <div class="row">
            ...
            <div class="col-md-6 position-blk">
              <div class="morning-img">
                <a href="/medic/service-schedules.html">
              ...
              <div class="col-12 col-md-12 col-xl-8">
                <div class="card">
                  <div class="card-header">
                    ...
                    <a href="/medic/appointments.html" class="patient-views float-end">Mostre tudo</a>
                  </div>
                        ...
                        <tbody>
                          <tr>
                            <td class="table-image appoint-doctor">
                              <img width="28" height="28" class="rounded-circle"src="../assets/img/profiles/avatar-01.jpg" alt />
          ...
          <div class="col-12 col-lg-12 col-xl-5 d-flex">
            <div class="card flex-fill comman-shadow">
              <div class="card-header">
                ...
                <a href="/medic/appointments.html" class="patient-views float-end">Show all</a>
              </div>
              <div class="card-body">
                      ...
                      <div class="dolor-activity hide-activity">
                        <ul class="doctor-date-list mb-2">
                          ...
                          <li class="dropdown ongoing-blk">
                            <a href="/medic/#" class="dropdown-toggle active-doctor" data-bs-toggle="dropdown">
                              <i class="fas fa-circle me-2 active-circles"></i>08:00 <span>Lorem Ipsum </span><span
                                class="ongoing-drapt">Ongoing
                                <i class="feather-chevron-down ms-2"></i></span>
                            </a>
                            <ul class="doctor-sub-list dropdown-menu">
                              <li class="patient-new-list dropdown-item">
                                Patient<span>Marie kennedy</span><a href="javascript:;" class="new-dot status-green"><i
                              ...
                              <li class="schedule-blk mb-0 pt-2 dropdown-item">
                                <ul class="nav schedule-time">
                                  <li>
                                    <a href="/medic/javascript:;"><img src="../assets/img/icons/trash.svg" alt /></a>
                                  </li>
                                  <li>
                                    <a href="/medic/javascript:;"><img src="../assets/img/icons/profile.svg" alt /></a>
                                  </li>
                                  <li>
                                    <a href="/medic/javascript:;"><img src="../assets/img/icons/edit.svg" alt /></a>
                                  </li>
                                </ul>
            ...
            <div class="col-12 col-xl-12">
              <div class="card">
                <div class="card-header pb-0">
                  ...
                  <a href="/medic/patients.html" class="float-end patient-views">Mostre tudo</a>
                </div>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="table-image">
                            <img width="28" height="28" class="rounded-circle" src="../assets/img/profiles/avatar-01.jpg"
                              alt />
                            <h2>Lorem Ipsum</h2>
                          </td>
                          <td>21</td>
  ...
  <script src="../assets/plugins/datatables/jquery.dataTables.min.js"
    type="289d0519ad93de500f359347-text/javascript"></script>
  <script src="../assets/plugins/datatables/datatables.min.js" type="289d0519ad93de500f359347-text/javascript"></script>
  ...
  <script src="../assets/plugins/apexchart/apexcharts.min.js" type="289d0519ad93de500f359347-text/javascript"></script>
...
<!-- Mirrored from preclinic.dreamstechnologies.com/html/template/doctor-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Jun 2024 21:42:55 GMT -->
