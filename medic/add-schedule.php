                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-heading">
                                                <h4>Adicionar Agenda</h4>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6 col-xl-6">
                                            <div class="input-block local-forms">
                                                <label>Nome do Médico <span class="login-danger">*</span></label>
                                        ...
                                        <div class="col-12 col-md-6 col-xl-4">
                                            <div class="input-block local-forms cal-icon">
                                                <label>Dias Disponíveis <span class="login-danger">*</span></label>
                                        ...
                                        <div class="col-12 col-md-6 col-xl-4">
                                            <div class="input-block local-forms">
                                                <label>Até <span class="login-danger">*</span></label>
                                                <div class="time-icon">
                                            ...
                                            <div class="input-block select-gender">
                                                ...
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" name="gender" class="form-check-input">Ativo
                                                    </label>
                                                </div>
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" name="gender"
                                                            class="form-check-input">Inativo
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="doctor-submit text-end">
                                                <button type="submit" class="btn btn-primary submit-form me-2">Criar
                                                    Agenda</button>
                                                <button type="submit"
