    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                if (isset($_GET['id'])) {
                    $id = intval($_GET['id']);
                    $sql = "SELECT id, nome, carteirinha, carteirinhaDoutor, doctor, procedimento, sessoes, dataRetorno, obs FROM guia WHERE id = ?";
                                        ...
                                        <div class="card-box">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 espaco">
                                                    ...
                                                    <h5><?php echo $row["carteirinha"]; ?></h5>
                                                </div>
                                                <div class="col-lg-12 espaco">
                                                    <h4>Médico(a)</h4>
                                                ...
                                                <div class="col-lg-12 espaco">
                                                    <h4>Carteirinha do médico(a)</h4>
                                                    <h5><?php echo $row["carteirinhaDoutor"];  ?></h5>
                                                </div>

                                                <div class="col-lg-12 espaco">
                                                    <h4>Procedimento indicado</h4>
                                                    <h5><?php echo $row["procedimento"]; ?></h5>
                                                </div>
                                                <div class="col-lg-12 espaco">
                                                    <h4>Quantidade de sessões</h4>
                                                    <h5><?php echo $row["sessoes"]; ?></h5>
                                                </div>
                                                <div class="col-lg-12 espaco">
                                                    <h4>Data de vencimento da guia</h4>
                                                    <h5><?php echo date("d.m.Y", strtotime($row["dataRetorno"])); ?></h5>
                                                </div>
                                                <div class="col-lg-12 espaco">
                                                    <h4>Observaçõeso</h4>
                                                    <h5><?php echo $row["obs"]; ?></h5>
                                                </div>
