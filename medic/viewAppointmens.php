            ...
            <div class="content">
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="inbox.php">Consultas</a></li>
                                <li class="breadcrumb-item">
                                    <i class="feather-chevron-right"></i>
                                </li>
                                <li class="breadcrumb-item active">Ver Consulta</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                if (isset($_GET['id'])) {
                    $id = intval($_GET['id']);
                    $sql = "SELECT id, doctor, carteirinhaPaciente, date, status, time FROM agendamentos WHERE id = ?";
                                    ...
                                    <div class="col-xl-8">
                                        <div class="card-box">
                                            <div class="compose-mail">
                                                <h3>Consulta N° <?php echo $row["id"]; ?></h3>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12 espaco">
                                                    <h4>Nome do Médico(a):</h4>
                                                    <h5><?php echo $row["doctor"]; ?></h5>
                                                </div>
                                                <div class="col-lg-12 espaco">
                                                    <h4>Carteirinha do Paciente</h4>
                                                    <h5><?php echo $row["carteirinhaPaciente"]; ?></h5>
                                                </div>
                                                <div class="col-lg-12 espaco">
                                                    <h4>Data</h4>
                                                ...
                                                <div class="col-lg-12 espaco">
                                                    <h4>Status da consulta</h4>
                                                    <h5><?php echo $row["status"];  ?></h5>
                                                </div>

                                                <form method="post">
                                                    <h4>Qual o status da consulta?</h4>
                                                    <select class="form-control" name="status" id="status">
                                                        <option value="Concluído">Concluído</option>
                                                        <option value="Inconcluído" selected>Inconcluído</option>
                                                    </select>
                                                    <button type="submit" onclick="atualizarPagina()" class="btn btn-primary">Atualizar Status</button>
                                                </form>
                                                <?php
                                                ...
                                                if ($id > 0 && !empty($status)) {
                                                    // Atualizar o campo status na tabela agendamentos
